...
def run_experiment(hparams):
    ...
    exporter = tf.estimator.FinalExporter('jirapred',
    ...
    estimator = model.build_estimator(
        ...
        # Construct layers size with exponential decay
        hidden_units=[
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--embedding-size',
        help='Numner of embedding dimensions of categorical columns',
        default=8,
        type=int
    )
    parser.add_argument(
    ...
    # Arguments to turn on all logging
    parser.add_argument(
        '--verbosity',
        choices=[
            'DEBUG',
